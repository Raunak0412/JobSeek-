...
export const candidates: CandidateProfile[] = [
  ...
  },
  {
    ...
    availability: "Immediate",
    sentiment: "Analytical",
    summary: "Owns financial planning cycles, variance analysis, and stakeholder-ready reporting across fast-moving business teams.",
    skills: ["Financial Modeling", "Forecasting", "Excel", "Power BI", "SQL", "Variance Analysis"],
    strengths: ["Strong reporting clarity", "Reliable forecasting discipline", "Excellent business partnering"],
    scorecard: [],
  },
  {
    id: "cand-rahul",
    ...
    currentRole: "FP&A Analyst",
    location: "Gurugram, India",
    experience: "4 years",
    category: "Finance",
    availability: "2 weeks",
    sentiment: "Balanced",
    summary: "Supports budgeting, monthly close reporting, and executive dashboards with clean analytical communication.",
    skills: ["Budgeting", "Financial Planning", "Excel", "Power BI", "Forecasting", "Stakeholder Reporting"],
    strengths: ["Executive-ready reports", "Cross-functional finance support", "Steady planning execution"],
    scorecard: [],
  },
  {
    id: "cand-ananya",
    ...
    currentRole: "Senior Finance Analyst",
    location: "Bengaluru, India",
    experience: "6 years",
    category: "Finance",
    availability: "30 days",
    sentiment: "Confident",
    summary: "Builds decision-support dashboards, drives budget reviews, and translates financial signals into hiring and growth recommendations.",
    skills: ["Financial Modeling", "Budgeting", "Excel", "SQL", "Tableau", "Dashboard Reporting"],
    strengths: ["High ownership language", "Board-friendly summaries", "Strong analytical depth"],
    scorecard: [],
  },
]
...
export const candidatePublicProfiles: Record<string, CandidatePublicProfile> = {
  ...
  "cand-nisha": {
    headline: "Finance analyst focused on forecasting rigor, dashboards, and stakeholder-ready reporting.",
    about: "I turn business and financial data into planning clarity, with a strong focus on accurate forecasts and crisp reporting for leadership teams.",
    photoUrl: "/placeholder-user.jpg",
    techSkills: [
      { name: "Financial Modeling", level: 94 },
      { name: "Forecasting", level: 92 },
      { name: "Excel", level: 96 },
    ...
    timeline: [
      {
        ...
        company: "LedgerNest",
        period: "2022 - Present",
        highlights: ["Owned monthly forecasting packs for GTM and operations leaders.", "Improved variance reporting turnaround by 35% with automated dashboards."],
      },
      {
        role: "Business Finance Associate",
        company: "NorthPeak Retail",
        period: "2020 - 2022",
        highlights: ["Prepared budgeting models and business review decks.", "Partnered with department heads on spend planning and performance tracking."],
      },
    ],
    education: [{ degree: "MBA in Finance", school: "NMIMS Mumbai", year: "2020" }],
    socialLinks: {
      linkedin: "https://linkedin.com/in/nisha-patel-finance",
      portfolio: "https://nishapatel-finance.dev",
    },
    resume: {
      fileName: "Nisha_Patel_Finance_Analyst_Resume.pdf",
      updatedAt: "April 2, 2026",
      highlights: [
        "Built rolling forecasts used in weekly leadership reviews.",
        "Created finance dashboards linking hiring, spend, and business performance.",
        "Translated financial signals into clear action items for department leads.",
      ],
      projects: ["Quarterly planning model", "Finance operations dashboard", "Variance review automation"],
    },
  },
  "cand-rahul": {
    headline: "FP&A analyst balancing budgeting discipline with fast, readable business reporting.",
    about: "I work at the intersection of planning, reporting, and business storytelling, helping leaders understand where numbers are moving and why.",
    photoUrl: "/placeholder-user.jpg",
    techSkills: [
      { name: "Budgeting", level: 93 },
      { name: "Financial Planning", level: 91 },
      { name: "Excel", level: 95 },
    ...
    timeline: [
      {
        ...
        period: "2023 - Present",
        highlights: ["Prepared quarterly budget re-forecasts across three business units.", "Built reporting packs used by finance, hiring, and operations managers."],
      },
      {
        role: "Financial Analyst",
        company: "Riverbank Services",
        period: "2021 - 2023",
        highlights: ["Supported monthly close insights and variance commentary.", "Improved stakeholder reporting consistency with template automation."],
      },
    ],
    education: [{ degree: "B.Com in Accounting and Finance", school: "Delhi University", year: "2021" }],
    socialLinks: {
      linkedin: "https://linkedin.com/in/rahul-verma-fpa",
    },
    resume: {
      fileName: "Rahul_Verma_FPA_Resume.pdf",
      updatedAt: "April 1, 2026",
      highlights: [
        "Owned recurring budget and forecast updates for growth and operations.",
        "Built reporting views that improved cross-team finance visibility.",
      ],
      projects: ["Executive finance summary pack", "Budget variance tracker", "Hiring cost planning model"],
    },
  },
  "cand-ananya": {
    headline: "Senior finance analyst for KPI dashboards, budget reviews, and decision support.",
    about: "My work combines financial analysis, reporting structure, and business alignment so leadership can act quickly with confidence.",
    photoUrl: "/placeholder-user.jpg",
    techSkills: [
      { name: "Financial Modeling", level: 91 },
    ...
    timeline: [
      {
        ...
        company: "VistaCore",
        period: "2022 - Present",
        highlights: ["Built executive dashboards connecting hiring plans to departmental budgets.", "Led analysis for monthly business reviews and investment decisions."],
      },
      {
        role: "Finance Analyst",
        company: "BlueOrbit Systems",
        period: "2019 - 2022",
        highlights: ["Maintained budget vs actual models for multiple teams.", "Improved dashboard reliability by linking reporting directly to SQL-based data pulls."],
      },
    ],
    education: [{ degree: "PGDM in Finance", school: "SPJIMR Mumbai", year: "2019" }],
    socialLinks: {
      linkedin: "https://linkedin.com/in/ananya-rao-finance",
      website: "https://ananyarao-analytics.dev",
    },
    resume: {
      fileName: "Ananya_Rao_Senior_Finance_Analyst_Resume.pdf",
      updatedAt: "April 3, 2026",
      highlights: [
        "Connected finance reporting to hiring and workforce planning decisions.",
        "Delivered high-confidence budget decks and dashboard summaries for leadership.",
      ],
      projects: ["Headcount planning dashboard", "Budget review command center", "SQL-backed finance reporting suite"],
    },
  },
}
