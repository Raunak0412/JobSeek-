        ...
        {authMode === "demo" ? (
          <div className="rounded-3xl border border-violet-500/15 bg-violet-500/10 p-4">
            <div className="flex items-start gap-3">
              <div className="mt-0.5 rounded-2xl bg-white/10 p-2 text-violet-100">
                <Sparkles className="h-4 w-4" />
              </div>
              <div className="flex-1">
                <p className="font-medium text-violet-100">Demo access</p>
                <p className="mt-1 text-sm leading-6 text-violet-50/80">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link href="/auth/forgot-password" className="text-sm text-violet-400 hover:text-violet-200">
                Forgot password?
              </Link>
            </div>
            <Input
