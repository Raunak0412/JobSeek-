...
import { getRankedCandidates, recruiterJobs } from "@/lib/mock-data"
...
export default function CandidatesPage() {
  ...
  const rankedCandidates = useMemo(() => {
    return getRankedCandidates(jobId).filter((candidate) =>
          ...
          <Card className="rounded-[1.75rem] border-white/10 bg-[#081321]">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-400">{job.company} · {job.vacancies} openings · {rankedCandidates.length} strong matches</p>
              </div>
            ...
            <CardContent className="space-y-4">
                  ...
                  <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                    <div className="flex items-start gap-4">
                      <Checkbox
                        ...
                        className="mt-1 border-white/20 data-[state=checked]:border-cyan-300 data-[state=checked]:bg-cyan-300"
                      />
              ...
              <div className="rounded-[1.6rem] border border-cyan-400/15 bg-cyan-400/10 p-4 text-sm leading-6 text-cyan-100">
