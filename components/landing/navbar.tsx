      ...
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mt-4 flex h-16 items-center justify-between rounded-2xl border border-white/10 bg-black/30 px-4 backdrop-blur-xl">
          <Link href="/" className="flex items-center gap-2">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-violet-500 to-lime-500">
          ...
          <div className="hidden items-center gap-3 md:flex">
            ...
            <Link href="/auth/register">
              <Button className="bg-gradient-to-r from-violet-500 to-lime-500 text-white hover:from-violet-400 hover:to-lime-400">
                Get Started
              </Button>
            </Link>
          </div>
            ...
            >
              <div className="flex flex-col gap-2">
                ...
                <Link href="/auth/register" onClick={() => setIsOpen(false)}>
                  <Button className="w-full bg-gradient-to-r from-violet-500 to-lime-500">
                    Get Started
                  </Button>
                </Link>
              </div>
