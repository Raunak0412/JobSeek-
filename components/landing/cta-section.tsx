...
export function CTASection() {
  return (
    <section className="relative overflow-hidden bg-zinc-950 py-24 sm:py-32">
      ...
      <div className="absolute left-1/2 top-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-indigo-500/20 via-purple-500/20 to-cyan-500/20 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        >
          <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-cyan-500">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link href="/auth/register">
              <Button
                size="lg"
                className="group h-14 gap-2 bg-gradient-to-r from-indigo-500 to-cyan-500 px-10 text-lg font-semibold text-white transition-all hover:from-indigo-600 hover:to-cyan-600 hover:shadow-lg hover:shadow-indigo-500/25"
              >
                Get Started Free
